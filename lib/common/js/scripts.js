...
$(function () {
  ...
  $('[data-accordion-type="basic"]').each(function () {
    let $accordion = $(this),
      accordion_id = $accordion.attr('id');

    $accordion.find('[data-accordion="item"]').each(function (index) {

      $(this)
        .find('[data-accordion="trigger"]')
        .attr('aria-controls', accordion_id + '_' + index);

      $(this)
        .find('[data-accordion="panel"]')
        .attr('id', accordion_id + '_' + index);
    });
  });
